...
namespace Planned.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(string.Format("Planned.controllers.{0}.xml", controller), string.Format("Planned.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("Planned.Reports.{0}", name), string.Format("Planned.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = Planned.Data.Controller.CreateConfigurationInstance(t, controller);
