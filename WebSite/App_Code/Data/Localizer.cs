...
namespace Planned.Data
{
    ...
    public class Localizer
    {
        ...
        public static Stream CreateDictionaryStream(string culture, string baseName, string objectName, out string[] files)
        {
            ...
            var result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(string.Format("Planned.{0}{1}", baseName, fileName), culture));
            if (result == null)
        ...
        public static LocalizationDictionary CreateDictionary(string baseName, string objectName)
        {
            ...
            var fileName = string.Format("Planned.{0}.{1}.txt", objectName, culture);
