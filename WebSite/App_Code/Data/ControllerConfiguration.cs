...
namespace Planned.Data
{
	public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                var t = ApplicationServices.StringToType("Planned.Rules.SharedBusinessRules");
                if (t != null)
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    var stream = GetType().Assembly.GetManifestResourceStream(string.Format("Planned.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
