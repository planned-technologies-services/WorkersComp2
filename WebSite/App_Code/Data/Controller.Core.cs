    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (string.IsNullOrEmpty(survey))
            	survey = ControllerConfigurationUtility.GetResourceText(string.Format("Planned.Surveys.{0}.min.js", surveyName), string.Format("Planned.{0}.min.js", surveyName), string.Format("Planned.Surveys.{0}.js", surveyName), string.Format("Planned.{0}.js", surveyName));
            if (string.IsNullOrEmpty(survey))
            	throw new HttpException(404, "Not found.");
            if (string.IsNullOrEmpty(layout))
            	layout = ControllerConfigurationUtility.GetResourceText(string.Format("Planned.Surveys.{0}.html", surveyName), string.Format("Planned.Surveys.{0}.htm", surveyName), string.Format("Planned.{0}.html", surveyName), string.Format("Planned.{0}.htm", surveyName));
            if (string.IsNullOrEmpty(rules))
            	rules = ControllerConfigurationUtility.GetResourceText(string.Format("Planned.Surveys.{0}.rules.min.js", surveyName), string.Format("Planned.{0}.rules.min.js", surveyName), string.Format("Planned.Surveys.{0}.rules.js", surveyName), string.Format("Planned.{0}.rules.js", surveyName));
